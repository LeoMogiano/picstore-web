                                            ...
                                            <tr>
                                                ...
                                                @foreach ($eventos as $evento)
                                                    ...
                                                    <td>
                                                      ...
                                                      <p class="text-xs text-secondary mb-0">{{$evento->direccion}}</p>
                                                  </td>
                                                    @endif
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">{{$user_evento->estado}}</span>
                                                </td>
                                                @endif
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-secondary">{{$user_evento->estado}}</span>
                                                </td>
                                                @endif
                                                @foreach ($eventos as $evento)
                                                    @if ($user_evento->evento_id == $evento->id)
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold">{{ \Carbon\Carbon::parse($evento->fecha)->format('d/m/Y') }} </span>
                                                </td>
                                                @endif
                                                @endforeach
