            ...
            <div class="card mb-4 mx-0">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="#" class="btn bg-gradient-dark btn-sm mb-0" type="button">+&nbsp; Nuevo Usuario</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="  {{ $user->imagen ? $user->imagen : asset('img/team-2.jpg') }}" class="avatar avatar-sm me-3">
                                        </div>
                                    </td>
