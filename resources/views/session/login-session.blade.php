            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-gradient-dark">Bienvenido de nuevo</h3>
                  <p class="mb-0"><b>Inicia sesión</b></p>
              
                  <p class="mb-0">Recuerda no compartir..</p>
                  <p class="mb-0">Tus <b>credenciales</b> con <b>nadie</b>. </p>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Contraseña" value="secret" aria-label="Contraseña" aria-describedby="password-addon">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
