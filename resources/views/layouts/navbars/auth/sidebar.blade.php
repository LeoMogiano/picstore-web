...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header text-center" style="text-align: center; margin-top: -20px;">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="d-flex m-0 mb-5 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="{{ asset('img/picstore2.png') }}" class="navbar-brand-img img-fluid mx-auto my-0" style="max-width: 300px; width: 185px; max-height: 200px; height: 45px;" alt="..." />
    </a>
</div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link " href="{{ url('/dashboard') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-gradient-dark text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <i class="fas fa-home text-xs opacity-10" style="color: #ffffff;" aria-hidden="true"></i>
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{ url('user-profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-user text-sm opacity-10" style="color: #1d365d;"></i>
            </div>
            <span class="nav-link-text ms-1">Información de Perfil</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{ route('tarjetas.index') }}">
          ...
          <span class="nav-link-text ms-1">Metódo de Pago</span>
        </a>
      </li>
     ...
     @if(Auth::user()->rol == 'Administrador')
      <li class="nav-item">
        <a class="nav-link " href="{{ route('users.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <i class="fa fa-users text-sm opacity-10" style="color: #1d365d;"></i>
          </div>
      ...
      <li class="nav-item ">
        <a class="nav-link" href="{{ route('eventos.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                {{-- <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i> --}}          
                <i class="fas fa-calendar-check text-sm opacity-10" style="color: #1d365d;"></i>
              </div>
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{ route('user_evento.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i> --}}          
            <i class="fas fa-briefcase text-sm opacity-10" style="color: #1d365d;"></i>
          </div>
